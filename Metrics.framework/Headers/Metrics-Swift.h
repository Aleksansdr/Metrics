...
///
/// \endcode
SWIFT_CLASS("_TtC7Metrics7Metrics")
@interface Metrics : NSObject
/// The shared singleton session object.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) Metrics * _Nonnull shared;)
+ (Metrics * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
/// Immediately upload all unsent events regardless of <a href="x-source-tag://offlineMode">offlineMode</a>,
/// <a href="x-source-tag://eventUploadBatchSize">eventUploadBatchSize</a>
- (void)uploadEvents;
/// Initialize the mandatory Metrics SDK Credentials notably API key
/// \param apiKey Metrics SDK API key obtained from developer portal at https //api.approver.io/dev
///
///
/// throws:
/// <code>MetricsError.invalidAppKey</code>
- (BOOL)initializeWithApiKey:(NSString * _Nonnull)key error:(NSError * _Nullable * _Nullable)error;
...
/// \param ids Dynamic views ids 
///
- (void)dynamicViewsWithIds:(NSArray<NSString *> * _Nonnull)ids;
...
SWIFT_CLASS("_TtC7Metrics21MetricsViewController")
...
SWIFT_CLASS("_TtC7Metrics28MetricsViewControllerFactory")
@interface MetricsViewControllerFactory : NSObject
